...
// Respond to errors
void SimpleClient::error(int id, int errorCode, const std::string& errorMsg, const std::string& advancedOrderRejectJson) // int id, int code, const std::string& msg
{
  std::cout << "Error: " << errorCode << ": " << advancedOrderRejectJson << std::endl;
}
