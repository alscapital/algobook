...
/*
  ...
  void tickPrice(TickerId tickerId, TickType field, double price, const TickAttrib& attrib) {};         					// const
  void tickSize(TickerId tickerId, TickType field, int size) {};															// TickType
