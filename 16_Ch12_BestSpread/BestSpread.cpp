...
void BestSpread::tickSize(TickerId tickerId, TickType field, Decimal size) 
{
  // Determine the strike price and right
...
void BestSpread::error(int id, int errorCode, const std::string& errorMsg, const std::string& advancedOrderRejectJson) 
{
