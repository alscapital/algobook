...
int main() {
  ...
  ostr << std::put_time(&loc_tm, "%Y%m%d %H:%M:%S US/Eastern");   // "%Y%m%d, %H:%M:%S"       yyyymmdd hh:mm:ss
  client.reqMarketDataType(3);
  client.reqHistoricalData(3, con, ostr.str(), "6 M", "1 day",    //            "20240522 13:30:30 US/Eastern"
